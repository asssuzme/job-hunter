        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-6 text-muted-foreground">
            <section>
              ...
              <p className="mb-3">
                autoapply.ai collects the following information to provide our job application automation service:
              </p>
            ...
            <section>
              ...
              <p className="mt-2">
                Email: support@autoapply.ai<br />
                Website: https://gigfloww.com
              </p>
            </section>
